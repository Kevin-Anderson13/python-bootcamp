# Create Simple functions in Python
...
# only the values from the original list that are greater than its 2nd value. Print how many values this is 
...
def values_greater_than_second(first_list):
    new_list = []
    if len(first_list) < 2:
        return "False"
